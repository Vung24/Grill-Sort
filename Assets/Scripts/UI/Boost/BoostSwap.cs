...
public class BoostSwap : MonoBehaviour
{
    ...
    [SerializeField] private SwapFx _fxPresenter;
    ...
    public void OnUseBoost()
    {
        ...
        if (_fxPresenter != null)
        {
            ...
            {
                bool usedWithFx = BoostManager.Instance != null && BoostManager.Instance.UseSwapForMerge();
        ...
        bool usedSuccessfully = BoostManager.Instance.UseSwapForMerge();
