...
public class BoostRemove : MonoBehaviour
{
    ...
    [SerializeField] private RemoveFx _fxPresenter;
    ...
    public void OnUseBoost()
    {
        ...
        if (_fxPresenter != null)
        {
            ...
            {
                bool usedWithFx = BoostManager.Instance != null && BoostManager.Instance.UseRemoveThree();
        ...
        bool usedSuccessfully = BoostManager.Instance.UseRemoveThree();
